...
"github.com/go-openapi/swag"
    ...
    "swagger-practice-task/simple-server/models"
	"swagger-practice-task/simple-server/restapi/operations"
	"swagger-practice-task/simple-server/restapi/operations/todos"
)
